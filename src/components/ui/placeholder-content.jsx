...
const PlaceholderContent = () => {
  return (
    <div className="container mx-auto px-4 my-20">
      <p className="py-4 text-center bg-sweetPink-200 text-sweetPink-800 rounded-lg">
        ...
        <a
          ...
          href="https://pixelrocket.store/free-templates/react-templates/easy-tax-react-website-template"
        >
